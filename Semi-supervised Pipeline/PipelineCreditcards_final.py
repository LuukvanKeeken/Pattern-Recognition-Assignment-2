...
if __name__=="__main__":
    if (not os.path.exists('./Split Data')):
        os.mkdir('./Split Data')
    if (not os.path.exists('Accuracies and F1s')):
        os.mkdir('./Accuracies and F1s')
    ...
    for i in range(100):
        ...
        np.save('./Accuracies and F1s/knn_model_accs.npy', knn_model_accs)
        np.save('./Accuracies and F1s/knn_model_f1s.npy', knn_model_f1s)
        ...
        np.save('./Accuracies and F1s/lp_model_accs.npy', lp_model_accs)
        np.save('./Accuracies and F1s/lp_model_f1s.npy', lp_model_f1s)
        ...
        np.save('./Accuracies and F1s/knn_model2_accs.npy', knn_model2_accs)
        np.save('./Accuracies and F1s/knn_model2_f1s.npy', knn_model2_f1s)
